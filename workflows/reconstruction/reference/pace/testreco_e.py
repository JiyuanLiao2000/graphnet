...
def main(
    ...
    # [重资产移出] 加载 Energy 模型到 GPU
    model_path = "/storage/home/hcoda1/4/jliao74/r-itaboada3-0/jliao74/Energyreco_on_GRECOICDATA/model.pth"
    logger.info("Loading Energy model to GPU...")
