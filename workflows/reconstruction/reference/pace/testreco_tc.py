...
def main(
    ...
    # [重资产移出] 加载 TC 模型到 GPU
    model_path = "/storage/home/hcoda1/4/jliao74/r-itaboada3-0/jliao74/ClassTITO_on_GRECO_ICDATA/model.pth"
    logger.info("Loading TC model to GPU...")
...
if __name__ == "__main__":
    parser = ArgumentParser(description="Batch TC Inference with GraphNeT")
